...
C     fCoriCos  :: Coriolis Cos(phi) parameter at grid Center point (for NH)
     ...
     &  fCori, fCoriG, fCoriCos
      ...
      _RS hFacO          (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      ...
      _RS maskO          (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RS maskP          (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RS drC            (Nr+1)
      _RS drF            (Nr)
      _RS recip_drC      (Nr+1)
      _RS recip_drF      (Nr)
